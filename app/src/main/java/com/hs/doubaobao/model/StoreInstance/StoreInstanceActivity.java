package com.hs.doubaobao.model.StoreInstance;
...
import com.hs.doubaobao.adapter.StoreInstanceAdapter;
...
public class StoreInstanceActivity extends AppBarActivity implements StoreInstanceAdapter.onItemClickListener, PullToRefresh.PullToRefreshListener ,StoreInstanceContract.View{


    private RecyclerView mRecyclerView;
    private PtrClassicFrameLayout ptrFrame;
    private PtrClassicFrameLayout ptrFrame1;
    private StoreInstanceAdapter adapter;
    private List<ListBean> mList = new ArrayList<>();
    private LinkedHashMap<Object, Object> map;
    private StoreInstanceContract.Presenter presenter;
    private int page = 1;
    private int pages = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new StoreInstanceAdapter(this, mList, 1);
        adapter.setOnItemClickListener(this);
        mRecyclerView.setAdapter(adapter);
        initPtrClassicFrameLayout();
        //将Presenter和View进行绑定
        new StoreInstancePresener(this, this);
        //获取数据
    ...
    @Override
    public void setPresenter(StoreInstanceContract.Presenter presenter) {
