...
public class StoreInstancePresener implements StoreInstanceContract.Presenter {

    private static final String TAG ="CopyPresener" ;
    StoreInstanceContract.View viewRoot;


    private Context context;

    public StoreInstancePresener(StoreInstanceContract.View viewRoot, Context context) {
